...
public void nhap() {
	...
	System.out.println("Nhap lop hoc cua hoc sinh: ");
...
public String toString2() {
	return "Ma HS: "+getMa()+",\t Ho va ten: "+ getHoten()+",\t Lop hoc: "+ getKhoahoc()+",\t Gioi tinh: "+ getGioitinh() +",\t Ngay thang nam sinh: "+ getNgaysinh() +"/"+ getThangsinh()+"/"+getNamsinh()+",\t Dia chi: "+ getDiachi()+",\t So can cuoc cong dan: "+ getCCCD()+",\t So dien thoai: "+ getSdt()+",\t Hanh kiem: "+ getHanhkiem();
}
